...
namespace Acts\SphinxRealTimeBundle\Tests\Transformer\ModelToSphinxAutoTransformer;
...
class ModelToSphinxAutoTransformerTest extends \PHPUnit_Framework_TestCase
{
    public function setUp()
    {
        if (!class_exists('Sphinx_Document')) {
            ;
    ...
    {
        $transformer = new ModelToSphinxAutoTransformer();
        $document    = $transformer->transform(new POPO(), array('name' => array()));
        $data        = $document->getData();

        $this->assertInstanceOf('Sphinx_Document', $document);
